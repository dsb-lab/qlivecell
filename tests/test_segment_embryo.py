...
emb_segment, background, ls, embmask, backmask  = segment_embryo(image, ksize=ksize, ksigma=ksigma, binths=binths, checkerboard_size=checkerboard_size, num_inter=n_iter, smoothing=smoothing)
