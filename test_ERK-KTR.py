...
EmbSeg = EmbryoSegmentation(IMGS_ERK, ksize=5, ksigma=3, binths=[20,4], checkerboard_size=6, num_inter=100, smoothing=5, trange=range(17, 18), zrange=None)
EmbSeg()
EmbSeg.plot_segmentation(17, 20, extra_IMGS=IMGS_SEG)
