...
# save_cells(CT_0, path_save, embcode+'_ch%d' %0)

# cells, CT_0_info = load_cells(path_save, embcode+'_ch%d' %0)
# CT_0.plot_cell_movement()
# CT_0.plot_masks3D_Imagej(cell_selection=True, color=None, channel_name="0")
...
CT_1.plot_tracking(plot_stack_dims = (812, 812), plot_layout=(1,1), plot_outline_width=1)
save_cells(CT_1, path_save, embcode+'_ch%d' %1)
