...
def cell_segmentation3D_from3D(stack, segmentation_args, segmentation_method_args, min_outline_length):
    ...
    _Outlines, _Labels = segmentation_function(stack, segmentation_args, segmentation_method_args)
...
def cell_segmentation3D(stack, segmentation_args, segmentation_method_args, min_outline_length=100):
    ...
    Outlines, Masks, Labels = segmentation_function(stack, segmentation_args, segmentation_method_args, min_outline_length)
    return Outlines, Masks, Labels
